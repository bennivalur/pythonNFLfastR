...
def makegraphs(year_from, year_to,descr):


    data = pd.read_csv(descr + '_play_by_play_1999_to_2019.csv.gz', compression='gzip', low_memory=False)
    ...
    with open(descr + '/data.txt', 'w') as file:
